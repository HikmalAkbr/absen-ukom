                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><form class='d-inline'>
                                {{-- <a href='{{ url('mahasiswa2/'.$item->id_absen.'/edit')}}' class="btn btn-warning btn-sm">Edit</a> --}}
                              </form>  
                              <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ url('mahasiswa2/'.$item->id_absen) }}" method="post">
                                @csrf
                                @method('DELETE')
